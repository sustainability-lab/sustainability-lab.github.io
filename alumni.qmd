...
<div style="color: #4a5568;">Our second PhD graduate! Specialized in Gaussian Processes and Bayesian Machine Learning. Winner of Microsoft Research India PhD Award. Currently Postdoc at <span class="company">Microsoft Research India</span>.</div>
</div>
</div>
...
<div style="color: #4a5568;">Our first PhD graduate! Specialized in health sensing and respiratory monitoring technologies. Winner of multiple prestigious awards including Fulbright-Nehru Fellowship. Now Postdoctoral Researcher at <span class="university">University of Cambridge</span> with Prof. Cecilia Mascolo.</div>
</div>
</div>
</div>
...
<div style="text-align: center; margin: 40px 0; padding: 30px; background: #fafafa; border-radius: 12px; border: 1px solid #e2e8f0;">
<h3 style="color: #334155; margin-bottom: 16px;">Ready to Join This Amazing Network?</h3>
<p style="color: #475569; margin-bottom: 20px;">Start your journey with us and become part of a community that's making global impact</p>
<a href="openings.qmd" style="background: #334155; color: white; padding: 12px 24px; border-radius: 8px; text-decoration: none; font-weight: 600; margin-right: 10px;">View Open Positions</a>
<a href="experiences.qmd" style="background: transparent; color: #334155; border: 2px solid #334155; padding: 10px 22px; border-radius: 8px; text-decoration: none; font-weight: 600;">Read Alumni Stories</a>
</div>