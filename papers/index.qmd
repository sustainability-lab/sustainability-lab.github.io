...
<button class="paper-button"><a href="../papers/2024/IMWUT_JoulesEye.pdf" style="text-decoration: none; color: white;">PDF</a></button>
<button class="paper-button"><a href="https://indianexpress.com/article/cities/ahmedabad/research-scholar-at-iitgn-develops-device-to-overcome-fitness-monitoring-limitations-9180741/" style="text-decoration: none; color: white;">News coverage</a></button>
<button class="paper-button"><a href="https://www.youtube.com/watch?v=5J9KqrDnj20" style="text-decoration: none; color: white;">YouTube</a></button>
</div>
...
<button class="paper-button"><a href="../papers/2023/airdelhi.pdf" style="text-decoration: none; color: white;">PDF</a></button>
</div>
</div>
